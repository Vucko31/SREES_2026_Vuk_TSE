...
include_directories(BEFORE ${CMAKE_CURRENT_LIST_DIR}/src/compat)

file(GLOB TSECONV_CPP_SOURCES ${CMAKE_CURRENT_LIST_DIR}/src/*.cpp)
file(GLOB TSECONV_CPP_INCS ${CMAKE_CURRENT_LIST_DIR}/src/*.h)
...
file(GLOB_RECURSE TSECONV_COMPAT_INCS ${CMAKE_CURRENT_LIST_DIR}/src/compat/*.h)
